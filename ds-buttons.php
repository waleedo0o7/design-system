            ...
            <div class="ds-sub-section mb-5">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="mb-3">
                            <a href="#" class="btn btn-action btn-action-sm btn-primary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-sm btn-secondary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-sm btn-success"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-sm btn-danger"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-sm btn-warning"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-sm btn-info"> <i class="icon icon-star"></i> </a>
                        </div>
                        <div class="mb-3">
                            <a href="#" class="btn btn-action btn-primary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-secondary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-success"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-danger"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-warning"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-info"> <i class="icon icon-star"></i> </a>
                        </div>

                        <div class="mb-3">
                            <a href="#" class="btn btn-action btn-action-lg btn-primary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-lg btn-secondary"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-lg btn-success"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-lg btn-danger"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-lg btn-warning"> <i class="icon icon-star"></i> </a>
                            <a href="#" class="btn btn-action btn-action-lg btn-info"> <i class="icon icon-star"></i> </a>
                        </div>
            ...
            <div class="ds-sub-section mb-5">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <button href="#" class="btn btn-action btn-primary-faded"> <i class="icon icon-star"></i> </button>
                        <button href="#" class="btn btn-action btn-outline-primary"> <i class="icon icon-star"></i> </button>
